...
def main():
    ...
    print(sol.maxSatisfaction(satisfaction))    # Output: 14

    satisfaction = [4, 3, 2]
    print(sol.maxSatisfaction(satisfaction))    # Output: 20

    satisfaction = [-1, -4, -5]
    print(sol.maxSatisfaction(satisfaction))    # Output: 0
