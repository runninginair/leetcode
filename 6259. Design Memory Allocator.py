...
User Accepted:1677      User Tried:2157     Total Accepted:1695     Total Submissions:3291
Difficulty:Medium
...
memory units and allocate it with the id mID.
Return the block's first index. If such a block does not exist, return -1.

int free(int mID) Free all memory units with the id mID.
...
class Allocator:    ### My Solution, Passed.
